...
Pour que les notifications fonctionnent correctement, vous devez activer manuellement les notifications pour l'application dans les paramètres Android:

1. Allez dans **Paramètres** > **Applications** > **IsenSmartCompanion**.
